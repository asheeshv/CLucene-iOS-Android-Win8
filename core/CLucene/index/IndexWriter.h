...
public:
  ...
  DEFINE_CONDITION(THIS_WAIT_CONDITION)
	...
	*/
		//Modified the DEFAULT_MAX_FIELD_LENGTH to 1000000 from 10000
		//since it was hitting the upper bound while indexing the HCSB
	LUCENE_STATIC_CONSTANT(int32_t, DEFAULT_MAX_FIELD_LENGTH = 1000000);
